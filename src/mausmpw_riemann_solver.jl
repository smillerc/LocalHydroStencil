...
function _∂U∂t_ninepoint_orig(stencil::Stencil9Point, recon::F1, limiter::F2, skip_uniform=true) where {F1,F2}
    U⃗ = stencil.U⃗
    EOS = stencil.EOS
...
function _∂U∂t_ninepoint(stencil::Stencil9Point, recon::F1, limiter::F2, skip_uniform=true) where {F1,F2}
    U⃗ = stencil.U⃗
    EOS = stencil.EOS
